...
describe("Liquidation", function() {
  ...
  it("Should execute the flashloan and liquidate loans", async function() {
    ...
    console.log("Total amount of sUSD to burn:", sUSDTotalAmountToBurn.toString())
    
    let redenominateUSDC = 10**12
    let usdcEstimate = (sUSDTotalAmountToBurn.mul(100)).div(99).div(redenominateUSDC)
