...
// const sUSDLoanDataJson = require('../../data/sUSD-loanData.json')
...
describe("Collateral Value Getter", function() {
  ...
  it("Should return values of collateral in batches", async function() {
    ...
    let sETHAddresses = require('../../data/sETH-addresses.json')
    let sETHLoanIDs   = require('../../data/sETH-loanIDs.json')


    let returnData = await collateralOracle.batchGetLoanInformationSETH(sETHAddresses, sETHLoanIDs, addresses.sETH_loansAddress)
